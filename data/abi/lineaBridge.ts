export const lineaBridgeAbi = [
  ...
  { inputs: [], name: 'BytesLengthNotMultipleOf32', type: 'error' },
  {
    inputs: [{ internalType: 'uint256', name: 'bytesLength', type: 'uint256' }],
  ...
  },
  {
    ...
    name: 'DataEndingBlockDoesNotMatch',
    type: 'error',
  },
  {
    inputs: [
    ...
    name: 'DataHashesNotInSequence',
    type: 'error',
  },
  { inputs: [], name: 'DataParentHasEmptyShnarf', type: 'error' },
  {
    inputs: [
      { internalType: 'uint256', name: 'expected', type: 'uint256' },
      { internalType: 'uint256', name: 'actual', type: 'uint256' },
  ...
  { inputs: [], name: 'EmptyBlobData', type: 'error' },
  { inputs: [], name: 'EmptySubmissionData', type: 'error' },
  {
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'finalBlockNumber', type: 'uint256' },
      { internalType: 'uint256', name: 'lastFinalizedBlock', type: 'uint256' },
    ],
    name: 'FinalBlockNumberLessThanOrEqualToLastFinalizedBlock',
    type: 'error',
  },
  { inputs: [], name: 'FinalBlockStateEqualsZeroHash', type: 'error' },
  {
    inputs: [
      { internalType: 'bytes32', name: 'firstHash', type: 'bytes32' },
      { internalType: 'bytes32', name: 'secondHash', type: 'bytes32' },
    ],
    name: 'FinalStateRootHashDoesNotMatch',
    type: 'error',
  },
  { inputs: [], name: 'FinalizationDataMissing', type: 'error' },
  {
    inputs: [
      { internalType: 'uint256', name: 'l2BlockTimestamp', type: 'uint256' },
      {
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'firstBlockNumber', type: 'uint256' },
      { internalType: 'uint256', name: 'finalBlockNumber', type: 'uint256' },
    ],
  ...
  { inputs: [], name: 'FirstByteIsNotZero', type: 'error' },
  { inputs: [], name: 'InvalidMerkleProof', type: 'error' },
  { inputs: [], name: 'InvalidProof', type: 'error' },
  { inputs: [], name: 'InvalidProofType', type: 'error' },
  {
    inputs: [{ internalType: 'uint256', name: 'pauseType', type: 'uint256' }],
    name: 'IsNotPaused',
    type: 'error',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes32', name: 'rollingHash', type: 'bytes32' },
    ],
  ...
  { inputs: [], name: 'L2MerkleRootDoesNotExist', type: 'error' },
  {
    inputs: [
      { internalType: 'bytes32', name: 'expected', type: 'bytes32' },
  ...
  { inputs: [], name: 'LimitIsZero', type: 'error' },
  {
    inputs: [
  ...
  {
    inputs: [{ internalType: 'bytes32', name: 'rollingHash', type: 'bytes32' }],
  ...
  },
  {
    ...
    name: 'ParentHashesDoesNotMatch',
    type: 'error',
  },
  { inputs: [], name: 'PeriodIsZero', type: 'error' },
  { inputs: [], name: 'PointEvaluationFailed', type: 'error' },
  {
    inputs: [
      { internalType: 'uint256', name: 'fieldElements', type: 'uint256' },
      { internalType: 'uint256', name: 'blsCurveModulus', type: 'uint256' },
    ],
  ...
  { inputs: [], name: 'ProofIsEmpty', type: 'error' },
  {
    inputs: [
      { internalType: 'uint256', name: 'actual', type: 'uint256' },
      { internalType: 'uint256', name: 'expected', type: 'uint256' },
  ...
  { inputs: [], name: 'StartingRootHashDoesNotMatch', type: 'error' },
  {
    inputs: [
      { internalType: 'bytes32', name: 'expected', type: 'bytes32' },
      { internalType: 'bytes32', name: 'actual', type: 'bytes32' },
    ],
    name: 'StateRootHashInvalid',
    type: 'error',
  },
  {
    inputs: [
  ...
  { inputs: [], name: 'ValueSentTooLow', type: 'error' },
  { inputs: [], name: 'YPointGreaterThanCurveModulus', type: 'error' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bool', name: 'withProof', type: 'bool' },
    ],
    name: 'DataFinalized',
    type: 'event',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'endingBlock', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      { internalType: 'bytes32', name: 'finalStateRootHash', type: 'bytes32' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'bytes32', name: 'dataHash', type: 'bytes32' }],
    name: 'dataParents',
    outputs: [{ internalType: 'bytes32', name: 'parentHash', type: 'bytes32' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [{ internalType: 'bytes32', name: 'shnarfHash', type: 'bytes32' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'startingBlock', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'bytes', name: '_aggregatedProof', type: 'bytes' },
      { internalType: 'uint256', name: '_proofType', type: 'uint256' },
      {
        components: [
          {
            internalType: 'bytes32',
          ...
          { internalType: 'bytes32', name: 'dataParentHash', type: 'bytes32' },
          {
            internalType: 'uint256',
          ...
          { internalType: 'uint256', name: 'finalTimestamp', type: 'uint256' },
          { internalType: 'bytes32', name: 'l1RollingHash', type: 'bytes32' },
          {
            internalType: 'uint256',
        ...
        internalType: 'struct ILineaRollup.FinalizationData',
        name: '_finalizationData',
        type: 'tuple',
      },
    ],
    name: 'finalizeCompressedBlocksWithProof',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    ...
    name: 'finalizeCompressedBlocksWithoutProof',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'messageStatus', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_defaultVerifier', type: 'address' },
      { internalType: 'address', name: '_securityCouncil', type: 'address' },
  ...
  },
  {
    ...
    name: 'initializeLastFinalizedShnarf',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_messageNumber', type: 'uint256' },
    ],
  ...
  {
    inputs: [{ internalType: 'uint8', name: '_pauseType', type: 'uint8' }],
    name: 'isPaused',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'treeDepth', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'address', name: '_newVerifierAddress', type: 'address' },
      { internalType: 'uint256', name: '_proofType', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'bytes32', name: 'stateRootHash', type: 'bytes32' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'bytes32', name: 'snarkHash', type: 'bytes32' },
        ],
        internalType: 'struct ILineaRollup.SupportingSubmissionData',
        name: '_submissionData',
        type: 'tuple',
      },
      {
        internalType: 'uint256',
        name: '_dataEvaluationClaim',
        type: 'uint256',
      },
      { internalType: 'bytes', name: '_kzgCommitment', type: 'bytes' },
      { internalType: 'bytes', name: '_kzgProof', type: 'bytes' },
    ],
    name: 'submitBlobData',
    outputs: [],
    stateMutability: 'nonpayable',
    ...
    inputs: [
      {
        ...
        internalType: 'struct ILineaRollup.SubmissionData',
        name: '_submissionData',
        type: 'tuple',
      },
    ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'proofType', type: 'uint256' }],
    name: 'verifiers',
    outputs: [
